...
class GUI_Pause(GUI_Infos):
    ...
    def __init__(self, longueur, largeur):
        ...
        self.pause_manager = pygame_gui.UIManager((longueur, largeur), self.jeu.path+'json\\UI_Label_Pause.json')
...
class GUI_UnPause(GUI_Infos):
    ...
    def __init__(self, longueur, largeur,joueur):
        """"""
        super().__init__(longueur, largeur)
        self.unpause_manager = pygame_gui.UIManager((longueur, largeur), self.jeu.path+'json/UI_Label_UnPause.json')
...
class GUI_GameOver():
    ...
    def __init__(self, longueur, largeur, joueur):
        """"""
        self.jeu = Jeu()
        self.manager = pygame_gui.UIManager((longueur, largeur), self.jeu.path+'json/UI_Label_Pause.json')
        self.scoreText = pygame_gui.elements.UILabel(
